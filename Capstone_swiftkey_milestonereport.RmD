...
```{r chunk1, results='hide', message=FALSE, cache=TRUE}
library(qdap)
...
```{r chunk3, cache=TRUE, echo=FALSE}
...
infopl <- infopl + labs(title = "Figure 1: Approximate summary of three corpora")
infopl <- infopl + scale_y_log10()
infopl
...
```{r chunk71, cache=TRUE, echo=FALSE}
...
```{r chunk8, cache=TRUE, echo=FALSE}
...
annotate_figure(fig1, 
                top = text_grob("Top fifteen (15) Uni-gram toknes", 
                                color = "red", face = "bold"),
...
```{r chunk9, echo=FALSE, cache=TRUE}
...
annotate_figure(fig2, 
                top = text_grob("Top fifteen (15) Bi-gram tokens", 
                                color = "red", face = "bold"),
...
annotate_figure(fig3, 
                top = text_grob("Top fifteen (15) Tri-gram toknes", 
                                color = "red", face = "bold"),
...
```{r chunk11, cache=TRUE, echo=FALSE}
...
```{r chunk12, cache=TRUE, echo=FALSE}
...
```{r chunk13, cache=TRUE, echo=FALSE}
...
```{r chunk14, echo=FALSE, cache=TRUE}
...
```{r chunk15, results='hide', message=FALSE, eval=FALSE}
library(qdap)
library(qdapDictionaries)
library(tm)
library(ngram)
